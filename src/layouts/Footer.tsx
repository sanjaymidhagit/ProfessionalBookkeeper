    ...
    <Box
      ...
      <Container>
        <Grid container spacing={5}>
          ...
          >
            <Box component="span" sx={{color:"#528177"}}>П</Box>рофесиональный
            <br/>
            <Box component="span" sx={{color:"#528177"}}>Б</Box>уккипер
          </Typography>
          </Grid>
          <Grid item xs={12} sm={8} md={6} lg={5}>
            <Box sx={{display:"flex",flexWrap:"wrap",justifyContent:"space-between"}}>
            <Box sx={{width:{xs:"100%" , sm:"auto",},  mb:{xs:"15px" , sm:"0"}}}>
            <Typography variant="h6" color="#fff" sx={{mb:{xs:"10px" , sm:"20px"}, fontSize:{xs:"16px", md:"18px", lg:"20px"}}}>
            Программа
            </Typography>
        ...
        <Box>
          <Typography color="#fff" sx={{fontSize:{xs:"15px", sm:"16px" , md:"18px", lg:"20px"}}}>
